...
End-to-end bench of ten real OSS suites. PHP 8.4 Docker image, 4 workers,
...
| doctrine-orm | 3480 / 3480 | 6657 ms | 5823 ms | 1.1× |
| faker | 2462 / 2462 | 1465 ms | 1199 ms | 1.2× |
| guzzle-psr7 | 1250 / 1250 | 307 ms | 532 ms | 0.58× |
| php-parser | 1880 / 1880 | 682 ms | 558 ms | 1.2× |
| phpunit-itself | 4153 / 4153 | 1804 ms | 4261 ms | 0.42× |
| commonmark | 4168 / 4168 | 1367 ms | 902 ms | 1.5× |
| rector | 5239 / 5239 | 25444 ms | 10847 ms | 2.3× |
| monolog | 1154 / 1154 | 4639 ms | 1734 ms | 2.7× |
<!-- BENCH:TABLE:END -->

Test counts match vanilla exactly on all ten suites above.
...
The PHPUnit project's own test suite was attempted as an additional
...
- `--init` (or `tini`) — without it, Ctrl-C on `docker run` orphans the
  ...
  yourself when invoking proust directly.
...
The host script expects projects under `/tmp/proust-smoke/<name>`
