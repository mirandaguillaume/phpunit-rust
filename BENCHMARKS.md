...
End-to-end bench of nine real OSS suites. PHP 8.4 Docker image, 4 workers,
...
|---|---|---|---|---|
| brick-math | 20392 / 20392 | 2973 ms | 1071 ms | 2.8× |
| carbon | 6145 / 6145 | 35059 ms | 20285 ms | 1.7× |
| doctrine-orm | 3480 / 3480 | 7020 ms | 6005 ms | 1.2× |
| faker | 2462 / 2462 | 1503 ms | 1216 ms | 1.2× |
| guzzle-psr7 | 1250 / 1250 | 316 ms | 541 ms | 0.58× |
| php-parser | 1880 / 1880 | 693 ms | 570 ms | 1.2× |
| phpunit-itself | 4153 / 4153 | 1862 ms | 4320 ms | 0.43× |
| commonmark | 4168 / 4168 | 1448 ms | 917 ms | 1.6× |
| rector | 5239 / 5239 | 26608 ms | 11044 ms | 2.4× |
<!-- BENCH:TABLE:END -->

Test counts match vanilla exactly on all nine suites above.
