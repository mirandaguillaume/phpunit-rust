...
pub use discovery::{
    ...
    discover_in_dir, discover_in_dirs, discover_in_file, discover_with_index,
    format_shared_fixture_report, group_by_class, shared_fixture_report_in_dir,
    shared_fixture_report_in_file, GroupedMethod, SharedFixtureReport, TestCase, TestClass,
};
